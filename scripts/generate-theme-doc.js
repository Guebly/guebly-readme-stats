...
\`\`\`md
![GitHub Stats](https://readme.stats.guebly.com.br/api?username=YOUR_USERNAME&theme=guebly&show_icons=true)
\`\`\`
...
const createRepoMdLink = (theme) => {
  return `\n[${theme}_repo]: https://readme.stats.guebly.com.br/api/pin/?username=Guebly&repo=guebly-readme-stats&cache_seconds=86400&theme=${theme}`;
};
const createStatMdLink = (theme) => {
  return `\n[${theme}]: https://readme.stats.guebly.com.br/api?username=degabrielofi&show_icons=true&hide=contribs,prs&cache_seconds=86400&theme=${theme}`;
};
