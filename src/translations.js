...
const contributionsCardLocales = {
  "contributions.title": {
    en: "Contributions",
    "pt-br": "Contribuições",
    es: "Contribuciones",
  ...
  "contributions.total": {
    ...
    "pt-br": "contribuições no último ano",
    es: "contribuciones en el último año",
    de: "Beiträge im letzten Jahr",
    fr: "contributions cette année",
    it: "contributi nell'ultimo anno",
    ja: "過去1年のコントリビューション",
    "zh-cn": "过去一年的贡献",
    ko: "지난 1년간 기여",
    ru: "вкладов за последний год",
    ar: "مساهمة في العام الماضي",
    tr: "son yıldaki katkılar",
    pl: "wkładów w ostatnim roku",
    nl: "bijdragen in het afgelopen jaar",
    id: "kontribusi dalam setahun terakhir",
    vi: "đóng góp trong năm qua",
    hi: "पिछले वर्ष में योगदान",
  },
};

const workingOnCardLocales = {
  "workingon.title": {
    en: "is working on",
    "pt-br": "está trabalhando em",
    es: "está trabajando en",
    de: "arbeitet an",
    fr: "travaille sur",
    it: "sta lavorando su",
    ja: "が作業中",
    ...
    ru: "работает над",
    ar: "يعمل على",
    tr: "üzerinde çalışıyor",
    pl: "pracuje nad",
    nl: "werkt aan",
    id: "sedang mengerjakan",
    vi: "đang làm việc trên",
    hi: "पर काम कर रहा है",
  },
  "workingon.recent": {
    en: "RECENT ACTIVITY",
  ...
  "workingon.norepos": {
    en: "No public repositories found",
    "pt-br": "Nenhum repositório público encontrado",
    es: "No se encontraron repositorios públicos",
    de: "Keine öffentlichen Repositories gefunden",
    fr: "Aucun dépôt public trouvé",
    it: "Nessun repository pubblico trovato",
    ja: "公開リポジトリが見つかりません",
    "zh-cn": "未找到公开仓库",
    ko: "공개 저장소를 찾을 수 없습니다",
    ru: "Публичные репозитории не найдены",
    ar: "لم يتم العثور على مستودعات عامة",
    tr: "Herkese açık depo bulunamadı",
    pl: "Nie znaleziono publicznych repozytoriów",
    nl: "Geen openbare repositories gevonden",
    id: "Tidak ada repositori publik ditemukan",
    vi: "Không tìm thấy kho lưu trữ công khai",
    hi: "कोई सार्वजनिक रिपॉजिटरी नहीं मिली",
  },
};

const techStackCardLocales = {
  "techstack.title": {
    en: "Tech Stack",
    "pt-br": "Stack de Tecnologias",
    ...
    pl: "Stos technologii",
    nl: "Tech Stack",
    id: "Tumpukan Teknologi",
    vi: "Công nghệ sử dụng",
    hi: "टेक स्टैक",
  },
};

const compareCardLocales = {
  "compare.commits": {
    en: "Commits",
    "pt-br": "Commits",
    es: "Commits",
...
const sponsorsCardLocales = {
  ...
  "sponsors.sponsoring": {
    ...
    id: "Mensponsori",
    vi: "Đang tài trợ",
    hi: "प्रायोजित कर रहा है",
  },
  "sponsors.notenabled": {
    en: "GitHub Sponsors not enabled",
    "pt-br": "GitHub Sponsors não habilitado",
    es: "GitHub Sponsors no habilitado",
    de: "GitHub Sponsors nicht aktiviert",
    fr: "GitHub Sponsors non activé",
    it: "GitHub Sponsors non abilitato",
    ja: "GitHub Sponsorsが有効ではありません",
    "zh-cn": "GitHub Sponsors 未启用",
    ko: "GitHub Sponsors가 활성화되지 않았습니다",
    ru: "GitHub Sponsors не включен",
    ar: "رعاة GitHub غير مفعلة",
    tr: "GitHub Sponsors etkin değil",
    pl: "GitHub Sponsors nie jest włączony",
    nl: "GitHub Sponsors niet ingeschakeld",
    id: "GitHub Sponsors tidak diaktifkan",
    vi: "GitHub Sponsors chưa bật",
    hi: "GitHub Sponsors सक्रिय नहीं",
  },
  "sponsors.links": {
    en: "LINKS",
    "pt-br": "LINKS",
...
export {
  ...
  statCardLocales,
  wakatimeCardLocales,
  contributionsCardLocales,
  workingOnCardLocales,
  techStackCardLocales,
  compareCardLocales,
  sponsorsCardLocales,
};
