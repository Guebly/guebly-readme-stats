...
const CATEGORY_ICONS = {
  Frontend: "M7.375 16l3.77-12h1.48l-3.77 12h-1.48zM4.475 12.696l-3.4-4.281 3.4-4.281 1.167.928L2.575 8.415l3.067 3.353-1.167.928zM11.525 12.696l-1.167-.928 3.067-3.353-3.067-3.353 1.167-.928 3.4 4.281-3.4 4.281z",
  Backend: "M3 3a2 2 0 012-2h6a2 2 0 012 2v.223c0 .275.224.5.5.5.276 0 .5.224.5.5v8.554c0 .276-.224.5-.5.5a.5.5 0 00-.5.5V14a2 2 0 01-2 2H5a2 2 0 01-2-2v-.723a.5.5 0 00-.5-.5.5.5 0 01-.5-.5V3.723a.5.5 0 00.5-.5c.276 0 .5-.225.5-.5V3z",
  Systems: "M14 3.5V15a1 1 0 01-1 1H3a1 1 0 01-1-1V1a1 1 0 011-1h7.5L14 3.5zM4 4h6v1H4V4zm0 3h6v1H4V7zm0 3h6v1H4v-1z",
  Mobile: "M11 1a1 1 0 011 1v12a1 1 0 01-1 1H5a1 1 0 01-1-1V2a1 1 0 011-1h6zM5 0a2 2 0 00-2 2v12a2 2 0 002 2h6a2 2 0 002-2V2a2 2 0 00-2-2H5zm3 14a1 1 0 100-2 1 1 0 000 2z",
  DevOps: "M6 9a.5.5 0 01.5-.5h3a.5.5 0 010 1h-3A.5.5 0 016 9zM2 2a2 2 0 012-2h8a2 2 0 012 2v12a2 2 0 01-2 2H4a2 2 0 01-2-2V2zm2-1a1 1 0 00-1 1v4h10V2a1 1 0 00-1-1H4zm9 6H3v7a1 1 0 001 1h8a1 1 0 001-1V7z",
  ...
  Other: "M8 0a8 8 0 100 16A8 8 0 008 0zM1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0z",
};

const CATEGORY_ORDER = ["Frontend", "Backend", "Systems", "Mobile", "DevOps", "Data", "Other"];
...
export const renderTechStackCard = (data, options = {}) => {
  ...
  const title = custom_title || `${escapeHTML(data.name)}'s Tech Stack`;
  ...
  for (const cat of activeCategories) {
    ...
    langs.forEach((lang, i) => {
      ...
      categoriesSvg += `
        ...
        <text x="${x + 10}" y="${rowY}" font-size="10" dx="${escapeHTML(lang.name).length * 7 + 6}"
          font-family="'Segoe UI',Ubuntu,Sans-Serif"
