...
import { clamp } from "../common/ops.js";
import { svgFlex, textWidth } from "../common/render.js";
 ...
 */
const buildStatsCard = (stats, options = {}) => {
  const {
    name,
    totalStars,
    totalCommits,
...
export { buildStatsCard };
export default buildStatsCard;
