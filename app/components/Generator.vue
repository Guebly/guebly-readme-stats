        ...
        <div class="preview-area fade-up fade-d4">
          ...
          <div class="share-panel" v-if="generatedUrl || (cardType === 'full-profile' && username.trim())">
            ...
            <div class="share-row">
              ...
              <button class="share-btn embed" @click="openEmbed">
...
![Activity](${b}/api/activity-graph?username=${u}&${common})
...
const openEmbed = () => {
  if (!generatedUrl.value) return;
  const embedUrl = `${baseUrl}/embed.html?url=${encodeURIComponent(generatedUrl.value)}`;
...
.share-btn.embed:hover { border-color: var(--accent); color: var(--accent-light); }
.tip {
